...
class MLKEM:
    ...
    def generate_keypair(self) -> Tuple[bytes, bytes]:
        ...
        Returns: (public_key, secret_key) — 1184 and 2400 bytes respectively.
        """
    ...
    def encapsulate(self, public_key: bytes) -> Tuple[bytes, bytes]:
        ...
        Args: public_key: 1184-byte ML-KEM-768 public key.
        Returns: (ciphertext, shared_secret) — 1088 and 32 bytes.
        """
    ...
    def decapsulate(self, ciphertext: bytes) -> bytes:
        ...
        Args: ciphertext: 1088-byte ML-KEM-768 ciphertext.
        Returns: shared_secret: 32 bytes.
        Raises: RuntimeError: If no keypair has been generated yet.
        """
